...
* [x] Hides the toolbar while scrolling through the articles
* [x] Added more news desk values

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://thumbs.gfycat.com/SmallSoulfulAmericanindianhorse-size_restricted.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

## Open-source libraries used

- [Android Async HTTP](https://github.com/loopj/android-async-http) - Simple asynchronous HTTP requests with JSON parsing
- [Picasso](http://square.github.io/picasso/) - Image loading and caching library for Android
- [Retrofit](http://square.github.io/retrofit/) - Type-safe REST client for Android developed by Square
## License

    Copyright [2016] [Bria Sullivan]
